...
- `cjt` at \\?\C:\Users\example\.claude\plugins-dev\cjt: marketplace root does not contain a supported manifest
```
...
New-Item -ItemType Junction `
  -Path 'C:\Users\example\.claude\plugins-dev\cjt' `
  -Target 'C:\Users\example\hub-vault\shared\plugins\cjt'
```
...
再 `Remove-Item 'C:\Users\example\.claude\plugins-dev\cjt'` 移除该 junction。在此之前不删。
