...
```powershell
$HubRepo   = 'C:\Users\example\ai-cli-migrate'
$Vault     = 'C:\Users\example\hub-vault'
$HostName  = '2025-bg-016'
$OldSource = 'C:\Users\example\.claude\plugins-dev'
$Stamp     = Get-Date -Format 'yyyyMMdd-HHmmss'
$Backup    = "C:\Users\example\hub-plugin-cutover-$Stamp"
...
`245735497+patrick1099@users.noreply.github.com`，hub-vault 当前为 `user@example.com`。若现场不同，先判断原因，
